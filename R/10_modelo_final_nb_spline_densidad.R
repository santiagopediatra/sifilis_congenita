...
dir.create("figures/bayes", recursive = TRUE, showWarnings = FALSE)
...
ggsave("figures/bayes/ppc_nb_spline_final_densidad_dens.png",
       p_dens, width = 9, height = 6, dpi = 100, bg = "white")
p_sd <- pp_check(fit_nb_spline, type = "stat", stat = "sd", ndraws = 1000)
ggsave("figures/bayes/ppc_nb_spline_final_densidad_var.png",
...
png("figures/bayes/posterior_predict_2021_final.png",
...
cat("Archivos guardados en output/bayes y figures/bayes.\n")
cat("=== FIN SCRIPT 10 ===\n")
