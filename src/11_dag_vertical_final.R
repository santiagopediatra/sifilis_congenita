...
if (!requireNamespace("rsvg", quietly = TRUE)) stop("Package rsvg is required")
...
svg_file <- "graficos/FigureS2_DAG_vertical.svg"
png_file <- "graficos/FigureS2_DAG_vertical.png"
pdf_file <- "graficos/FigureS2_DAG_vertical.pdf"
...
grid::grid.text("Conceptual DAG for Interpretation of the Maternal-Origin Contrast",
